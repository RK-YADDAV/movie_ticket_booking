     ...
     <div className='flex flex-col justify-between p-3 bg-gray-800 rounded-2xl
      ...
      <img
       ...
       <p className='font-semibold mt-2 truncate'>{movie.title}</p>
        ...
        <div className='flex items-centre justify-between mt-4 pb-3'>
            <button onClick={() => { navigate(`/movies/${movie._id}`); scrollTo(0, 0)}} 
            className='px-4 py-2 text-xs bg-red-600 hover:bg-red-700 transition rounded-full 
            font-medium text-white cursor-pointer'>Buy Tickets</button>
